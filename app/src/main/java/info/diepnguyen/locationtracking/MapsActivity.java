...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("Map Activity","on Create is running");
    }
        ...
        user_location.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot postSnapshot:dataSnapshot.getChildren())
                {
                    ...
                    //create function calculate distance between 2 locations
                    ;
                    ...
                    mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(Double.parseDouble(tracking.getLat()),Double.parseDouble(tracking.getLng())),12.0f));
                }
    ...
    protected void onResume() {
        super.onResume();
        Log.i("Map Activity","on Resume is running");
    ...
    protected void onPause() {
        super.onPause();
        Log.i("Map Activity","on Pause is running");
    }

    @Override
    protected void onStart() {
        super.onStart();
        Log.i("Map Activity","on Start is running");
    }

    @Override
    protected void onStop() {
        super.onStop();
        Log.i("Map Activity","on Stop is running");
    }

    @Override
    protected void onRestart() {
        super.onRestart();
        Log.i("Map Activity","on Restart is running");
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        Log.i("Map Activity","on Destroy is running");
    }
